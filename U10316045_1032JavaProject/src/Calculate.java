...
public class Calculate extends JPanel{
	...
	public Calculate(){
		...
		final JLabel cal4 = new JLabel("大卡(X碗飯)");
		JLabel kg = new JLabel("公斤");
		JLabel recommend = new JLabel("建議增減重天數 : ");
		JLabel plan = new JLabel("計畫專區");
		JLabel days = new JLabel("天");
		JLabel heightCal = new JLabel("每日最高熱量 : ");
		JLabel Doyouknow = new JLabel("你知道嗎？");
		JLabel knowledge = new JLabel("健康小常識！");
		JLabel sportsconsump = new JLabel("請選擇運動 : ");
		final JLabel time = new JLabel("運動多久了呢？");
		JLabel minute = new JLabel("分鐘"); 
		JLabel alreadyconsump = new JLabel("消耗了 : ");
		...
		Texttime.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e){
				...
				cal4.setText("大卡(" + DF.format(rice) + "碗飯)");
	...
	*/
	...
	//"騎腳踏車","走路","慢跑","打羽毛球","打桌球","打排球","打籃球","游泳","跳繩"
	...
	public void frame1(){
		...
		ImageIcon pic1 =  new ImageIcon(this.getClass().getResource("F1/"+arr1[1]+".PNG"));
		...
		Refresh.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e){
				...
				Label1.setIcon( new ImageIcon(this.getClass().getResource("F1/"+arr1[num]+".PNG")));
			}
		});
	...
	public void frame2(){
		...
		ImageIcon pic1 =  new ImageIcon(this.getClass().getResource("F2/"+1+".jpg"));
		final JLabel Label1 = new JLabel();
		Label1.setIcon(pic1);
	...
	public void frame3(){
		...
		ImageIcon pic1 =  new ImageIcon(this.getClass().getResource("F3/"+1+".PNG"));
	...
	public void frame4(){
		...
		ImageIcon pic1 = new ImageIcon(this.getClass().getResource("F4/"+arr1[1]+".jpg"));
		...
		Refresh.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e){
				int num = (int)(Math.random()*3 + 1);
				Label1.setIcon(new ImageIcon(this.getClass().getResource("F4/"+arr1[num]+".jpg")));
			}
		});
